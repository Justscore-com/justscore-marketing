...
>(({ className, ...props }, ref) => {
  ...
  return (
    <TabsPrimitive.List
      ref={ref}
      className={cn(
        "inline-flex w-full lg:gap-1 items-center p-1 justify-center bg-neutral-100 text-foreground-weak border-t border-neutral-200",
