  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "relative w-sidebar bg-transparent transition-[width] duration-150 ease-out",
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-10 hidden h-svh w-sidebar transition-[left,right,width] duration-150 ease-out lg:flex",
            side === "left"
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-6 shrink-0 items-center rounded-md px-2 text-2xs tracking-wide font-normal text-sidebar-foreground/70 outline-none ring-sidebar-ring transition-[opacity] duration-150 ease-out focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:stroke-1 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
...
>(({ className, ...props }, ref) => (
  <ul
    ...
    className={cn(
      "mx-3.5 mb-1 flex min-w-0 translate-x-px flex-col gap-0 border-l border-sidebar-border px-2.5 py-0 font-normal",
      "group-data-[collapsible=icon]:hidden",
      className
    )}
    {...props}
